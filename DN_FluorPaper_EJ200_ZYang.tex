...
\begin{table}[!ht]
\centering
  \caption{Light output ratios after irradiation of 1.68~Mrad at 0.84~krad/hr. Note that the uncertainty on the total dose is 10\%, and the uncertainty on the dose rate is estimated to be 20\%.}
  \begin{tabular}{c|c|c|c|c|c}
    \hline
    Sample		 &\begin{tabular}{@{}c@{}}Dose\\(Mrad)\end{tabular}  & \begin{tabular}{@{}c@{}}Dose rate \\(krad/hr)\end{tabular}  &$R_{285~nm}$	&$R_{350~nm}$	&$R_{400~nm}$	\\ \hline
    1X     	    	 & 1.68 & 0.84  &0.94 ${\pm}$ 0.02&0.94 ${\pm}$ 0.02	&0.88 ${\pm}$ 0.02	\\ \hline 
    2X     	    	 & 1.68 & 0.84  &0.95 ${\pm}$ 0.02&0.97 ${\pm}$ 0.02	&0.90 ${\pm}$ 0.02	\\ \hline
  \end{tabular}
  \label{table:castor}
\end{table}
