...
Using a $\rm {^{60}Co}$ source at the National Institute of Standard and Technology, these samples were irradiated  
at rates of 10 krad/hr and 429 krad/hr to a total dose of 3 Mrad. 
Additional samples that were produced in the same batch were kept for calibration and comparison.
...
Light from the lamp is collected by a diamond-turned elliptical mirror and focused on the entrance slit of the excitation monochromator.The entrance and exit slits of the excitation monochromator are continuously adjustable, 
...
After correcting the PMT and the photodiode's signals according to their quantum efficiencies, 
...
(Include instrument diagram from the manual and cite it?)
...
The sample' placement in the spectrometer adopts the front-surface configuration, which gives the excitation beam a sixty-degree 
incident angle and maximizes fluorescence emission at the surface. 
This minimizes the effect of self absorption when measuring fluorescence yield after irradiation. 
(include the diagram for front-surface excitation here)
